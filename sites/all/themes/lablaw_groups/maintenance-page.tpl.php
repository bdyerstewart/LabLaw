 ...
 *
 * This is an override of the default maintenance page. Used for lablaw_groups and
 * Minnelli, this file should not be moved or modified since the installation
 * and update pages depend on this file.
 *
 * This mirrors closely page.tpl.php for lablaw_groups in order to share the same
 * styles.
 */
