			...
			<?php if ( $display_submitted ) : ?>
				<div class="submitted node-submitted" role="contentinfo">
					...
					<?php if ( $submitted ) : // node author ?>
						<span class="node-author"><span class="fa fa-user"></span> <?php print t( "by " ) . $submitted; ?></span>
					<?php endif;
					...
					<span class="node-comments">
						<span class="fa fa-comment"></span> <a href="<?php echo $node_url;?>#comments"><?php print t( "Comments " ) . $comment_count; ?> </a>
					</span>
				</div>
			<?php endif; ?>
		</header>
