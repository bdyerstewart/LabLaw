 ...
 */
if($is_front){
    drupal_add_css(drupal_get_path('theme', 'theme1033'). "/front-page.css");
}
?>


<?php if ( !theme_get_setting( 'theme1033_breadcrumb_show' ) ) :
	$breadcrumb = NULL;
endif; ?>
...
<div id="page-wrapper" class="page-wrapper">
	<div id="page" class="page">
		...
		<header id="header" class="header page-header clearfix" role="banner">
			...
			<div class="<?php if ( theme_get_setting( 'theme1033_sticky_menu' ) ) { echo 'stickup '; } ?>header-section-2"> <!-- Sticky menu wrapper -->
				<div class="container-12">
					<div class="grid-12">
						<!-- Region Menu -->
						<?php if ( $page['menu'] ) :
			...
			<!-- Region Header -->
			<?php if ( $page['header'] ) :
				theme1033_region_preffix ( 'header' );
					print render( $page['header'] );
				theme1033_region_suffix ( 'header' );
			endif; ?>

			<!-- Region Header bottom -->
			<?php if ( $page['header_bottom'] ) :
				theme1033_region_preffix ( 'header_bottom' );
					print render( $page['header_bottom'] );
				theme1033_region_suffix ( 'header_bottom' );
			endif; ?>
		</header>
		...
		<div id="main-wrapper" class="main-wrapper" role="main">
			...
			<?php if ( $page['content_top'] ) :
				theme1033_region_preffix ( 'content_top' );
					print render( $page['content_top'] );
				theme1033_region_suffix ( 'content_top' );
			endif; ?>
			...
			<?php if ( $page['section_1'] ) :
				theme1033_region_preffix ( 'section_1' );
					print render( $page['section_1'] );
				theme1033_region_suffix ( 'section_1' );
			endif; ?>

			<!-- Region Section 2 -->
			<?php if ( $page['section_2'] ) :
				theme1033_region_preffix ( 'section_2' );
					print render( $page['section_2'] );
				theme1033_region_suffix ( 'section_2' );
			endif; ?>

			<!-- Region Section 3 -->
			<?php if ( $page['section_3'] ) :
				theme1033_region_preffix ( 'section_3' );
					print render( $page['section_3'] );
				theme1033_region_suffix ( 'section_3' );
			endif; ?>

			<!-- Region Section 4 -->
			<?php if ( $page['section_4'] ) :
				theme1033_region_preffix ( 'section_4' );
					print render( $page['section_4'] );
				theme1033_region_suffix ( 'section_4' );
			endif; ?>

			<!-- Region Section 5 -->
			<?php if ( $page['section_5'] ) :
				theme1033_region_preffix ( 'section_5' );
					print render( $page['section_5'] );
				theme1033_region_suffix ( 'section_5' );
			endif; ?>

			<!-- Region Section 6 -->
			<?php if ( $page['section_6'] ) :
				theme1033_region_preffix ( 'section_6' );
					print render( $page['section_6'] );
				theme1033_region_suffix ( 'section_6' );
			endif; ?>

			<!-- Region Content bottom -->
			<?php if ( $page['content_bottom'] ) :
				theme1033_region_preffix ( 'content_bottom' );
					print render( $page['content_bottom'] );
				theme1033_region_suffix ( 'content_bottom' );
			endif; ?>
		</div>
		...
		<footer id="footer" class="footer page-footer" role="contentinfo">
			...
			<?php if ( $page['footer_top'] ) :
				theme1033_region_preffix ( 'footer_top' );
					print render( $page['footer_top'] );
				theme1033_region_suffix ( 'footer_top' );
			endif; ?>
			...
			<div id="footer-wrapper" class="footer-wrapper">
				<div class="container-12">
					<div class="grid-12">
						...
						<?php if ( $is_front ) : ?>
							<!--More <a rel="nofollow" href="http://www.templatemonster.com/category.php?category=484&type=26" target="_blank">Bank Templates at TemplateMonster.com</a>-->
						<?php endif; ?>
					</div>
				</div>
			</div>
			...
			<?php if ( $page['footer_bottom'] ) :
				theme1033_region_preffix ( 'footer_bottom' );
					print render( $page['footer_bottom'] );
				theme1033_region_suffix ( 'footer_bottom' );
			endif; ?>
		</footer>
	</div>
</div>
